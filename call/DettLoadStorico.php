...
$p=$htmlpath.$rs_usr.'dettStorico.html';
$f=fopen($p,'r');
...
$p=$htmlpath.$rs_usr.'dettRimborsoKmStorico.html';
$f=fopen($p,'r');
$rimborsoKm=fread($f,filesize($p));
$rimborsoKm.=$js;

$p=$htmlpath.$rs_usr.'dettHotelStorico.html';
$f=fopen($p,'r');
$hotel=fread($f,filesize($p));
$hotel.=$js;

$p=$htmlpath.$rs_usr.'dettHotelFiglioStorico.html';
$f=fopen($p,'r');
$hotel_figlio=fread($f,filesize($p));
$hotel_figlio.=$js;
...
$p=$htmlpath.$rs_usr.'newStorico.html';
$f=fopen($p,'r');
...
foreach($results as $v){
	...
	$s_tmp=str_replace('[dett_edit]','pi.requestQ(\'messageBox\',\'Msg\')',$s_tmp);
