...
<div id="tappa_add">
	<table width="100%">
		...
		$out.='<tr>
			...
			<th>Data</th>
			<td><input id="data_id_'.$v2['id_tappa'].'" name="datatime" type="text" value="'.$v2['data'].'"/></td>
			<script>$(\'#data_id_'.$v2['id_tappa'].'\').datepicker()</script>
			...
			<input type="hidden" name="data" 	id="data_hid_'.$v2['id_tappa'].'">
			<input type="hidden" name="Q" value="Trasf_Itin_Edit_Db">
			</div>
			<div id="tappa_del'.$v2['id_tappa'].'">
			<input type="hidden" name="Q" value="Trasf_Itin_Del_Db">
			<input type="hidden" name="id_tappa" value="'.$v2['id_tappa'].'">
			</div>
		</tr>';
		}
		$out.='
			...
			<input type="hidden" name="Q" value="Trasf_Itin_Add_Db">
			<th>Luogo</th>
