...
$s=str_replace('[contabilizza]',str_replace('[contabilizza_call]','pi.requestQ(\'trasf_id[id_trasf]\',\'Contabilizza\')',carica_file($htmlpath.'buttonContabilizza.html')),$s);
$s=str_replace('[allegato]',str_replace('[allegato_call]','pi.requestQ(\'trasf_id[id_trasf]\',\'WinTrasfAllegato\')',carica_file($htmlpath.'buttonAllegato.html')),$s);
